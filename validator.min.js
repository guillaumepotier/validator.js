/*! Validator.js validator.min.js build version 0.4.2 http://validatorjs.org */
(function(l){function k(a){return"[object Array]"===Object.prototype.toString.call(a)}var f=function(a){this.__version__="0.4.0";this.__class__="Validator";this.options=a||{};this.bindingKey=this.options.bindingKey||"_validatorjsConstraint";return this};f.prototype={constructor:f,validate:function(a,b,c){if("string"!==typeof a&&"object"!==typeof a)throw Error("You must validate an object or a string");return"string"===typeof a?this._validateString(a,b,c):this.isBinded(a)?this._validateBindedObject(a,
b):this._validateObject(a,b,c)},version:function(){return this.__version__},bind:function(a,b){if("object"!==typeof a)throw Error("Must bind a Constraint to an object");a[this.bindingKey]=new g(b);return this},unbind:function(a){if("undefined"===typeof a._validatorjsConstraint)return this;delete a[this.bindingKey];return this},isBinded:function(a){return"undefined"!==typeof a[this.bindingKey]},getBinded:function(a){return this.isBinded(a)?a[this.bindingKey]:null},_validateString:function(a,b,c){var e,
j=[];k(b)||(b=[b]);for(var f=0;f<b.length;f++){if(!(b[f]instanceof h))throw Error("You must give an Assert or an Asserts array to validate a string");e=b[f].check(a,c);e instanceof d&&j.push(e)}return j.length?j:!0},_validateObject:function(a,b,c){if("object"!==typeof b)throw Error("You must give a constraint to validate an object");return(new g(b)).check(a,c)},_validateBindedObject:function(a,b){return a[this.bindingKey].check(a,b)}};f.const={must_be_a_string:"must_be_a_string",must_be_an_array:"must_be_an_array",
must_be_a_number:"must_be_a_number"};var g=function(a){this.__class__="Constraint";this.nodes={};if(a)try{this._bootstrap(a)}catch(b){throw Error("Should give a valid mapping object to Constraint",b,a);}return this};g.prototype={constructor:g,check:function(a,b){var c,e={},d;for(d in a)if(this.has(d)&&(c=this._check(d,a[d],b),k(c)&&0<c.length||!k(c)&&!_isEmptyObject(c)))e[d]=c;return _isEmptyObject(e)?!0:e},add:function(a,b){if(b instanceof h||k(b)&&b[0]instanceof h)return this.nodes[a]=b,this;if("object"===
typeof b&&!k(b))return this.nodes[a]=b instanceof g?b:new g(b),this;throw Error("Should give an Assert, an Asserts array, a Constraint",b);},has:function(a){return"undefined"!==typeof this.nodes[a.toLowerCase()]},get:function(a,b){return"undefined"!==typeof this.nodes[a]?this.nodes[a]:b||null},remove:function(a){var b=[],c;for(c in this.nodes)c!==a&&(b[c]=this.nodes[c]);this.nodes=b;return this},_bootstrap:function(a){if(a instanceof g)return this.nodes=a.nodes;for(var b in a)this.add(b,a[b])},_check:function(a,
b,c){if(this.nodes[a]instanceof h)return this._checkAsserts(b,[this.nodes[a]],c);if(k(this.nodes[a]))return this._checkAsserts(b,this.nodes[a],c);if(this.nodes[a]instanceof g)return this.nodes[a].check(b,c);throw Error("Invalid node",this.nodes[a]);},_checkAsserts:function(a,b,c){for(var e,d=[],f=0;f<b.length;f++)e=b[f].check(a,c),"undefined"!==typeof e&&!0!==e&&d.push(e);return d}};var d=function(a,b,c){this.__class__="Violation";if(!(a instanceof h))throw Error("Should give an assertion implementing the Assert interface");
this.assert=a.__class__;this.value=b;"undefined"!==typeof c&&(this.violation=c)};d.prototype={show:function(){var a={assert:this.assert,value:this.value};this.violation&&(a.violation=this.violation);return a},__toString:function(){if("undefined"!==typeof this.violation)var a='", '+this.getViolation().constraint+" expected was "+this.getViolation().expected;return this.assert+' assert failed for "'+this.value+a||""},getViolation:function(){var a,b;for(a in this.violation)b=this.violation[a];return{constraint:a,
expected:b}}};var h=function(a){this.__parentClass__=this.__class__="Assert";this.groups=[];"undefined"!==typeof a&&this.addGroup(a);return this};h.prototype={construct:h,check:function(a,b){if(!b||this.hasGroup(b))if(b||!this.hasGroups())try{return this.validate(a,b)}catch(c){return c}},hasGroup:function(a){return"string"!==typeof a?this.hasOneOf(a):!this.hasGroups()?"Default"===a:-1!==this.groups.indexOf(a)},hasOneOf:function(a){for(var b=0;b<a.length;b++)if(this.hasGroup(a[b]))return!0;return!1},
hasGroups:function(){return 0<this.groups.length},addGroup:function(a){if(k(a))return this.addGroups(a);this.hasGroup(a)||this.groups.push(a);return this},removeGroup:function(a){for(var b=[],c=0;c<this.groups.length;c++)a!==this.groups[c]&&b.push(this.groups[c]);this.groups=b;return this},addGroups:function(a){for(var b=0;b<a.length;b++)this.addGroup(a[b]);return this},Blank:function(){this.__class__="Blank";this.validate=function(a){if("string"!==typeof a)throw new d(this,a,{value:f.const.must_be_a_string});
if(""!==a.replace(/^\s+/g,"").replace(/\s+$/g,""))throw new d(this,a);return!0};return this},Callback:function(a){this.__class__="Callback";if("function"!==typeof a)throw Error("Callback must be instanciated with a function");this.fn=a;this.validate=function(b){var c=a(b,this);if(!0!==c)throw new d(this,b,{result:c});return!0};return this},Choice:function(a){this.__class__="Choice";if(!k(a)&&"function"!==typeof a)throw Error("Choice must be instanciated with an array or a function");this.list=a;this.validate=
function(a){for(var c="function"===typeof this.list?this.list():this.list,e=0;e<c.length;e++)if(a===c[e])return!0;throw new d(this,a,{choices:c});};return this},Collection:function(a){this.__class__="Collection";this.constraint="undefined"!==typeof a?new g(a):!1;this.validate=function(a,c){var e,j=new f,g=0,h={},l=this.groups.length?this.groups:c;if(!k(a))throw new d(this,array,{value:f.const.must_be_an_array});for(var m=0;m<a.length;m++)e=this.constraint?j.validate(a[m],this.constraint,l):j.validate(a[m],
l),_isEmptyObject(e)||(h[g]=e),g++;return!_isEmptyObject(h)?h:!0};return this},Count:function(a){this.__class__="Count";this.count=a;this.validate=function(a){if(!k(a))throw new d(this,a,{value:f.const.must_be_an_array});var c="function"===typeof this.count?this.count(a):this.count;if(isNaN(Number(c)))throw Error("Count must be a valid interger",c);if(c!==a.length)throw new d(this,a,{count:c});return!0};return this},Email:function(){this.__class__="Email";this.validate=function(a){if("string"!==typeof a)throw new d(this,
a,{value:f.const.must_be_a_string});if(!/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a))throw new d(this,
