...
typeof a?new g(a):!1;this.validate=function(a,c){var f,k=new e,h=0,g={},m=this.groups.length?this.groups:c;if(!l(a))throw new d(this,array,{value:e.errorCode.must_be_an_array});for(var p=0;p<a.length;p++)f=this.constraint?k.validate(a[p],this.constraint,m):k.validate(a[p],m),n(f)||(g[h]=f),h++;return!n(g)?g:!0};return this},Count:function(a){this.__class__="Count";this.count=a;this.validate=function(a){if(!l(a))throw new d(this,a,{value:e.errorCode.must_be_an_array});var c="function"===typeof this.count?
this.count(a):this.count;if(isNaN(Number(c)))throw Error("Count must be a valid interger",c);if(c!==a.length)throw new d(this,a,{count:c});return!0};return this},Email:function(){this.__class__="Email";this.validate=function(a){if("string"!==typeof a)throw new d(this,a,{value:e.errorCode.must_be_a_string});if(!/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a))throw new d(this,
...
return!0}};"function"===typeof define&&define.amd&&define(function(){return m})})("undefined"===typeof exports?this["undefined"!==typeof validatorjs_ns?validatorjs_ns:"Validator"]={}:exports);
