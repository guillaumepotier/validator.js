...
typeof a?new g(a):!1;this.validate=function(a,c){var f,j=new e,g=0,h={},l=this.groups.length?this.groups:c;if(!k(a))throw new d(this,array,{value:e.const.must_be_an_array});for(var n=0;n<a.length;n++)f=this.constraint?j.validate(a[n],this.constraint,l):j.validate(a[n],l),m(f)||(h[g]=f),g++;return!m(h)?h:!0};return this},Count:function(a){this.__class__="Count";this.count=a;this.validate=function(a){if(!k(a))throw new d(this,a,{value:e.const.must_be_an_array});var c="function"===typeof this.count?
